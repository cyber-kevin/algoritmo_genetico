...
class GeneticAlgorithm:
    ...
    def __init__(self, number_of_individuals: int, mutation_percentage: float, number_of_generations: int):
...
if __name__ == '__main__':
    ...
    for gen in range(ga.number_of_generations):
        min_distances.append(min(individual.distance for individual in ga.population))
